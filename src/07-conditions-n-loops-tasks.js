...
function evaluateTicTacToePosition(position) {
  const res = [];
  for (let y = 0; y < 3; y += 1) { // строки
    res[y] = 0;
    for (let x = 0; x < 3; x += 1) { // столбцы
  ...
  if ((position[0][0] === position[1][1]) && (position[1][1] === position[2][2]) && (position[2][2] === 'X')) res[6] = 3;
  if ((position[0][2] === position[1][1]) && (position[1][1] === position[2][0]) && (position[2][0] === 'X')) res[7] = 3;
  if ((position[0][0] === position[1][1]) && (position[1][1] === position[2][2]) && (position[2][2] === '0')) res[6] = -3;
  if ((position[0][2] === position[1][1]) && (position[1][1] === position[2][0]) && (position[2][0] === '0')) res[7] = -3;

  if (res.includes(3)) { return 'X'; }
  if (res.includes(-3)) { return '0'; }
  return undefined;
}
